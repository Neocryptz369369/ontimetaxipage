...
export const metadata = { title: "On-Time Taxi · Driver app for iPhone" };
    ...
    <>
      <section className="bg-gradient-to-b from-blue-600 to-[#1a4d8f] text-white">
        <div className="max-w-4xl mx-auto px-6 py-20">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mt-4">Driver app<br/>for iPhone</h1>
          <p className="mt-4 text-xl text-white/90">Install On-Time Taxi for drivers on your iPhone.</p>
        </div>
      </section>
