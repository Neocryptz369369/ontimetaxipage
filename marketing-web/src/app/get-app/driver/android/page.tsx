...
export const metadata = { title: "On-Time Taxi · Driver app for Android" };
    ...
    <>
      <section className="bg-gradient-to-b from-blue-600 to-[#1a4d8f] text-white">
        <div className="max-w-4xl mx-auto px-6 py-20">
          ...
          <h1 className="text-5xl md:text-6xl font-extrabold mt-4">Driver app<br/>for Android</h1>
          <p className="mt-4 text-xl text-white/90">Install On-Time Taxi for drivers on your Android.</p>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="max-w-3xl mx-auto px-6 py-16">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg">
            ...
            <a href="/downloads/ontimetaxi-driver.apk" className="mt-6 inline-block bg-blue-600 text-white font-semibold px-6 py-3 rounded-lg hover:bg-blue-700 transition shadow">Download APK</a>
          </div>
