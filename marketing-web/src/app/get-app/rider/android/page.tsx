...
export const metadata = { title: "On-Time Taxi · Rider app · Android" };

export default function Page() {
  return (
    <section className="max-w-3xl mx-auto px-6 py-20">
      <Link href="/" className="text-sm text-blue-600">← Home</Link>
      <h1 className="text-4xl font-extrabold mt-4 text-brand">Rider app · Android</h1>
      ...
      <div className="mt-8 bg-white border rounded-2xl p-6 shadow-sm">
          ...
          <a href="/downloads/ontimetaxi-rider.apk" className="mt-6 inline-block bg-brand text-white font-semibold px-6 py-3 rounded-lg">Download APK</a>
      </div>
    </section>
  );
}
